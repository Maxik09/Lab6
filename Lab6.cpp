/*Author: Max Djafarov
Date:Octobe 22,2023
Pragram description: This program creates takes two square matracies as input and adds, subtracts, divides and multiplies them and gives a thirds matracy as the result
Collaborators: ChatGPT, used ai generative tool ChatGPT to help with the naming of the functions, also it used to help me create a function to read the matrix data from the file  */
